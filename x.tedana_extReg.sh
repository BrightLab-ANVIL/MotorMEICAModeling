...
parent_dir="/Volumes/NR_External/Multiecho_backup_01122024/Multiecho_03162023"
...
paste ${motion} ${CSF} ${task1}_trans.txt ${task2}_trans.txt > ${parent_dir}/BIDS/derivatives/${subject}/func/${task}/${subject}_${session}_${task}_extReg.txt
...
awk 'BEGIN {print "Mot_X\tMot_Y\tMot_Z\tMot_Pitch\tMot_Roll\tMot_Yaw\tCSF\tSignal_Right\tSignal_Left"} {print $0}' ${parent_dir}/BIDS/derivatives/${subject}/func/${task}/${subject}_${session}_${task}_extRegNohdr.tsv \
